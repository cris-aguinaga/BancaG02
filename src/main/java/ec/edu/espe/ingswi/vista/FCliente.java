...
public class FCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btncreacionCliente.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        btnactualizarCliente.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btncreacionCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 212, Short.MAX_VALUE)
    ...
    private void txtIngresoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIngresoKeyTyped
        ...
        if (c == '.' && txtIngreso.getText().contains(".")) {
            evt.consume();
        }
...
public static void main(final String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FCliente.class
